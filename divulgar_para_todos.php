...
<div class="container">
	...
	<p>Se, então, a sua enquete é para qualquer pessoa de qualquer lugar, então você pode solicitar nesta página que ela seja divulgada amplamente. Como essa divulgação acontece? Ela acontece na seção \"Enquetes para todos\", que pode estar na lateral direita ou junto ao rodapé da página atual. Seis enquetes aparecem nessa seção escolhidas aleatoriamente. Cada vez que se carrega uma nova página, outras seis enquetes aparecerão aleatoriamente nessas seções. Quando se passa o mouse em cima Porém, faremos uma análise da qualidade de sua enquete, para saber se ela tem qualificação suficiente para ter ampla divulgação. Se for simplesmente impossível saber o que você está querendo saber com sua enquete ou questionário, enviaremos um e-mail a você dizendo que não será possível divulgar amplamente sua enquete</p>");
	?>
