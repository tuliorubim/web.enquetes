...
<div class="container">
	...
	$inputs = array("hidden", "");
	$properties = "class='input-lg'";
	$formTabela1 = array($variaveis, NULL, $labels, $inputs, NULL, "categoria", NULL, $properties);
	
	$variaveis = array("idEnquete", "cd_categoria", "cd_usuario", "enquete", "introducao", "dt_criacao", "disponivel", "duracao", "code", "url", "esconder", "hide_results", "acima_de_cem", "end_date");
	$tipos = array('integer', 'integer', 'integer', 'varchar', 'varchar', 'datetime', 'boolean', 'integer', 'varchar', "varchar", 'boolean', 'boolean', 'boolean', 'date');
	$labels = array("", "", "", "Enquete", 'Introdu&ccedil;&atilde;o', "", '', '', '', '', '', '', '', 'Data de t&eacute;rmino');
	$inputs = array("hidden", "hidden", "hidden", "text", "textarea", "hidden", "hidden", "hidden", "hidden", "hidden", "hidden", "hidden", "hidden", "text");
	$maxlengths = array("", "", "", "64", "1024", '', '', '', '12', '256', '', '', '', '10');
	$tabela = "enquete";
...
$(document).ready(function () {
	...
	$("input[name='salvar']").click(function () {
		if ($("#end_date").val().length > 0)
			conditions['end_date'] = 'dd/mm/yyyy';
		else conditions['end_date'] = null;	
