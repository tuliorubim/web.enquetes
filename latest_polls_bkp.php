<!-- ULTIMAS ENQUETES -->
<?php
$args = select("select idEnquete, enquete from enquete where disponivel = 1 order by idEnquete desc limit 6");
?>
<div class="container">
	<div class="row">
    <div class="col-lg-12"><h1 class="titu-enquetes">&Uacute;ltimas Enquetes</h1>
    </div>
    </div>
    <div class="row">
